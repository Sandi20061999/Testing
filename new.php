    ...
    echo "[+] File Token saved in ".$live." \n";
                  echo "[+] Mencoba Redem Voucher Pertama\n";
                    ...
                    sleep(9);
                        ...
                        $claima = curl('https://api.gojekapi.com/go-promotions/v1/promotions/enrollments', '{"promo_code":"GOFOODSANTAI08"}', headers($access_token));
                  echo "[+] Mencoba Redem Voucher kedua\n";
                    ...
                    sleep(9);
                        ...
                        $claimb = curl('https://api.gojekapi.com/go-promotions/v1/promotions/enrollments', '{"promo_code":"GOFOODSANTAI19"}', headers($access_token));
...
$url = 'https://eu48.chat-api.com/instance79426/message?token=03ualut0p0rlaarh';
// Make a POST request
